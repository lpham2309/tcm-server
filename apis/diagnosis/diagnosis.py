...
class PatientDiagnosis(Resource):
    ...
    def put(self, patient_id):
        ...
        cursor.execute(query, (data['doctor_id'], data['assistant_doctor_id'], data['doctor_notes'], data['symptoms_id'], data['syndrome_id'], patient_id,))
    ...
    def post(self, patient_id):
        ...
        cursor.execute(query, (data['diagnosis_id'], data['assistant_doctor_id'], patient_id, data['assistant_doctor_notes'], data['doctor_notes'], data['symptoms_id'], data['syndrome_id'],))
        db.connection.commit()
