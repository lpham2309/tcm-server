...
api.add_resource(PatientDiagnosis, '/api/v1/diagnosis/<patient_id>')
api.add_resource(DiagnosisInformation, '/api/v1/diagnosis/<user_id>')
api.add_resource(SymptomsList, '/api/v1/symptoms')
api.add_resource(QuestionController, '/api/v1/questions')
